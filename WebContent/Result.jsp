...
PreparedStatement ps=conn.prepareStatement("select userid,examname,SUM(Marks) from  system.examresult where userid='"+userid+"' and examname='"+exam+"'group by userid,examname");
